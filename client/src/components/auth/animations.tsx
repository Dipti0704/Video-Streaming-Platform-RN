...
export const handleTouch = async (updateAccessToken: () => void) => {
    ...
    Animated.sequence([
        ...
        // Hardcoded guest user for simple login
        const guestUser = {
        ...
        try {
            const apiRes = await login(guestUser, updateAccessToken)
            if (apiRes) {
                startImageAnimation()
            } else {
...
export const startImageAnimation = () => {
    ...
    // Navigate faster to home after animation starts
    console.log('Setting timeout for navigation to home in 3 seconds...')
    setTimeout(() => {
        console.log('Timeout elapsed - Navigating to home...')
